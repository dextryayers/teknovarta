...
import { Play, Eye, Clock, User, Share2, Facebook, Twitter, MessageCircle, ChevronRight, Bookmark, ArrowLeft, Sparkles } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50/50 dark:bg-blue-900/10 p-8 rounded-3xl border border-blue-100 dark:border-blue-900/30">
                 <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-sm font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest">Ringkasan AI</h3>
                 </div>
