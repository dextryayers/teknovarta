...
import { User, Calendar, Eye, ShieldCheck, ChevronRight, MessageCircle, Clock, Bookmark, ArrowLeft, Sparkles } from 'lucide-react';
          ...
          <main className="lg:col-span-8">
            ...
            {article.aiSummary && (
              <motion.div 
                ...
                className="bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-2xl p-6 mb-10 border border-purple-100 dark:border-purple-800/50 relative overflow-hidden group shadow-sm"
              >
                <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                  <Sparkles className="h-20 w-20 text-purple-600 dark:text-purple-400" />
                </div>
                <div className="flex items-center gap-2 mb-4">
                  <div className="h-8 w-8 rounded-lg bg-purple-600 flex items-center justify-center shadow-lg shadow-purple-500/30">
                    <Sparkles className="h-4 w-4 text-white" />
                  </div>
                  <div>
                    <h3 className="text-sm font-black text-purple-900 dark:text-purple-100 uppercase tracking-tight">AI Insights</h3>
                    <p className="text-[10px] font-bold text-purple-600/70 dark:text-purple-400/70 uppercase tracking-widest">Ringkasan Otomatis TeknoVarta</p>
                  </div>
                </div>
               ...
               <div className="flex items-start gap-8 relative z-10">
                  ...
                  <div className="space-y-4">
                     <div>
                        ...
                        <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest">Technology Enthusiast & Content Creator</p>
                     </div>
                     <p className="text-sm text-slate-400 leading-relaxed font-medium">Berawal dari hobi dan kecintaan mendalam pada dunia digital, saya ingin terus berbagi wawasan serta informasi menarik seputar teknologi untuk kita semua.</p>
